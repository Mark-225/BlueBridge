...
public class RegionSnapshot {
    ...
    public RegionSnapshot(String addon, String id, String htmlDisplay, UUID world, int height, boolean depthCheck, List<Vector2d> points, Color color, Color borderColor) {
        this.addon = addon;
        this.id = id;
